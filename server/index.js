...
app.post('/cart', authenticateJWT, async (req, res) => {
  try {
    ...
    // Enrich items with current product details so DB shows name and price
    ...
    // Replace entire cart items with normalized items (server is source of truth)
    const cart = await cartModel.findOneAndUpdate(
      { userId },
      { items: normalizedItems, updatedAt: new Date() },
