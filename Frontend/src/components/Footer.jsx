    ...
    <footer style={styles.footer}>
      ...
      <div style={styles.container}>
        ...
        <div style={styles.section}>
          ...
          <Link to="/menu" style={styles.link}>Our Menu</Link>
          <Link to="/about" style={styles.link}>About Us</Link>
          <Link to="/orders" style={styles.link}>Order History</Link>
      ...
      <div style={styles.bottomBar}>
        ...
        <div style={styles.bottomLinks}>
          ...
          <Link to="/admin/login" style={{...styles.bottomLink, opacity: 0.7}}>Admin Login</Link>
        </div>
      </div>
    </footer>
  );
